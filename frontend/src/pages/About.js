...
const team = [
  {
    name: 'Maryam Fraz',
    role: 'Lead Developer',
    avatar: 'https://ui-avatars.com/api/?name=Maryam+Fraz&background=4f46e5&color=fff',
    id: 'BSE233031'
  },
  {
    name: 'Shanzay Atta',
    role: 'Backend Developer',
    avatar: 'https://ui-avatars.com/api/?name=Shanzay+Atta&background=0ea5e9&color=fff',
    id: 'BSE233043'
  },
  {
    name: 'Ayesha Khalid',
    role: 'UI/UX Developer',
    avatar: 'https://ui-avatars.com/api/?name=Ayesha+Khalid&background=f59e0b&color=fff',
    id: 'BSE233046'
  },
  {
    name: 'Aliza Maryam',
    role: 'Project Manager',
    avatar: 'https://ui-avatars.com/api/?name=Aliza+Maryam&background=10b981&color=fff',
    id: 'BSE233020'
  }
];
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'3rem', alignItems:'start' }}>
            <div>
              ...
              <p style={{ color:'var(--muted)', lineHeight:1.9, marginBottom:'1rem' }}>
                NASEER was founded by software engineering students at CUST, Islamabad, who believed that technology could be a force for humanitarian good.
              </p>
